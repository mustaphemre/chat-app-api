...
{
    public static IHostApplicationBuilder AddUserApiInfrastructureServices(this IHostApplicationBuilder builder)
    {
        builder.AddSqlServerDbContext<UsersDbContext>(ServiceNames.DATABASE.DATABASE_NAME);
